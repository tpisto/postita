...
* Test that you can login to postita.fi web interface with the same credentials and reset the password if needed.
*
* @class Postita
* @constructor
...
var Postita = (function () {
  function Postita(user, pass) {
    _classCallCheck(this, Postita);

    this.auth = { 'auth': { 'user': user, 'pass': pass } };
    this.apiUrl = 'https://postita.fi/api/';
  }

  _createClass(Postita, [{
    key: 'send',
    ...
    */
    value: function send(job_name, pdf) {
      var optional = arguments[2] === undefined ? {} : arguments[2];

      var options = {
        uri: this.apiUrl + 'send',
        method: 'POST'
      };
      var form = { formData: { 'job_name': job_name, 'pdf': pdf.toString('base64') } };
    ...
    * @return {Object} Returns Promise
    */
    value: function send_finvoice(job_name, finvoice) {
      var optional = arguments[2] === undefined ? {} : arguments[2];
      ...
      var form = { formData: { 'job_name': job_name, 'finvoice': pdf.toString('base64') } };
    ...
    * @return {Object} Returns Promise
    */
    value: function send_with_address(job_name, pdf) {
      var optional = arguments[2] === undefined ? {} : arguments[2];
    ...
    * ```
    */
    value: function job_info(job_id) {
      var options = {
    ...
    * ```
    */
    value: function job_list(filter) {
...
exports.Postita = Postita;
//# sourceMappingURL=postita.js.map